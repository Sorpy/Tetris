...
public class JPiece extends TetrisPiece {
    public JPiece(Point navigationPoint, List<Block> blockList) {
    ...
    private void rotateUP() {
        ...
        this.getBlockList().get(1).setBlockPoint(new Point(getNavigationPoint().x+2,getNavigationPoint().y));
    ...
    private void rotateLEFT() {
        ...
        this.getBlockList().get(3).setBlockPoint(new Point(getNavigationPoint().x+2,getNavigationPoint().y+1));
    }

    private void rotateDOWN() {
        this.getBlockList().get(0).setBlockPoint(new Point(getNavigationPoint().x+2,getNavigationPoint().y+2));
        this.getBlockList().get(1).setBlockPoint(new Point(getNavigationPoint().x+1,getNavigationPoint().y+2));
        this.getBlockList().get(2).setBlockPoint(new Point(getNavigationPoint().x+1,getNavigationPoint().y+1));
        this.getBlockList().get(3).setBlockPoint(new Point(getNavigationPoint().x+1,getNavigationPoint().y));
    }

    private void rotateRIGHT() {
        this.getBlockList().get(0).setBlockPoint(new Point(getNavigationPoint().x+3,getNavigationPoint().y));
        this.getBlockList().get(1).setBlockPoint(new Point(getNavigationPoint().x+3,getNavigationPoint().y+1));
        this.getBlockList().get(2).setBlockPoint(new Point(getNavigationPoint().x+2,getNavigationPoint().y+1));
        this.getBlockList().get(3).setBlockPoint(new Point(getNavigationPoint().x+1,getNavigationPoint().y+1));
    }
}
